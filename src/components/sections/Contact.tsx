    ...
    <section id="contacto" className="py-40">
      <div className="mx-container">
        <motion.div
          ...
          className="mb-16"
        >
          <span className="text-[11px] text-[#4F8CFF] uppercase tracking-[0.2em] font-mono mb-3 block">{t('contact.eyebrow')}</span>
          <h2 className="text-[clamp(2rem,4vw,3rem)] font-bold text-white tracking-tight mb-4">{t('contact.heading')}</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              <div>
                <label className="block text-xs text-[#71717A] mb-2 font-medium">{t('contact.name')}</label>
                <input type="text" placeholder={t('contact.namePlaceholder')} value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} className={input} required />
              </div>
              <div>
                <label className="block text-xs text-[#71717A] mb-2 font-medium">{t('contact.email')}</label>
                <input type="email" placeholder={t('contact.emailPlaceholder')} value={form.email} onChange={(e) => setForm({ ...form, email: e.target.value })} className={input} required />
              </div>
            </div>
            <div>
              <label className="block text-xs text-[#71717A] mb-2 font-medium">{t('contact.message')}</label>
              <textarea placeholder={t('contact.messagePlaceholder')} rows={7} value={form.message} onChange={(e) => setForm({ ...form, message: e.target.value })} className={`${input} resize-none`} required />
            </div>
          ...
          <motion.div
            ...
            className="space-y-3"
          >
            <p className="text-[#71717A] text-sm mb-6">{t('contact.direct')}</p>
