        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div className="text-center lg:text-left">
            ...
            >
              ...
              <span className="text-[11px] text-[#71717A] uppercase tracking-[0.2em] font-medium">{t('hero.openToWork')}</span>
            </motion.div>
            ...
            >
              {translations.hero.tags.map((tag) => (
            ...
            <div className="relative">
              ...
              >
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <p className="text-white text-[11px] font-medium leading-tight">{translations.hero.badge.org}</p>
                    <p className="text-[#71717A] text-[10px]">{translations.hero.badge.role}</p>
                  </div>
                </div>
              </motion.div>
            </div>
